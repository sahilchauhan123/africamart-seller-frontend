                            ...
                            <div className="w-full flex flex-col gap-14">
                                ...
                                <div className="flex flex-col gap-6">
                                    <div className="flex items-center justify-between px-4">
                                        <h2 className="text-slate-900 text-2xl md:text-4xl font-extrabold leading-tight tracking-tight">Operational Hub</h2>
                                ...
                                <div className="bg-primary/5 rounded-3xl p-10 text-center flex flex-col items-center gap-4">
                                    <h2 className="text-slate-900 text-2xl md:text-4xl font-extrabold leading-tight tracking-tight">Join the Trade Revolution</h2>
