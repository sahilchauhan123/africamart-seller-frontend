...
import { ChevronLeft, Camera, Lock, ArrowRight, ImagePlus, MapPin, FileText, Upload, CheckCircle2, Trophy } from 'lucide-react';
          ...
          <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-300">
            ...
            <div className="bg-[#F0F4FF] rounded-2xl p-5 space-y-4 shadow-sm border border-primary/5">
              ...
              <div className="relative">
                ...
                <select className="w-full px-4 py-3 rounded-xl bg-white border border-slate-200 focus:ring-4 focus:ring-primary/10 focus:border-primary outline-none transition-all font-bold text-slate-700 appearance-none shadow-sm cursor-pointer">
                  <option>{MOCK_USER.category}</option>
        ...
        return (
          <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-300 pb-10">
            ...
            <div className="space-y-4">
              <div className="bg-[#F0F4FF] rounded-2xl p-5 border border-primary/5 flex items-center justify-between group active:scale-[0.98] transition-all">
                <div className="flex items-center gap-4">
                  <div className="w-10 h-10 bg-white rounded-xl flex items-center justify-center text-primary shadow-sm">
                    <CheckCircle2 size={20} className="text-emerald-500" />
                  </div>
                  <div className="flex-1">
                    <h4 className="text-sm font-bold text-slate-800">Business License</h4>
                    <p className="text-[10px] text-emerald-600 font-bold uppercase tracking-tight">Verified • license.pdf</p>
                  </div>
                </div>
              ...
              <div className="bg-slate-50 rounded-2xl p-5 border border-dashed border-slate-200 flex items-center justify-between group active:scale-[0.98] transition-all">
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex-1">
                    <h4 className="text-sm font-bold text-slate-400">Identity Proof (CEO)</h4>
  ...
  return (
    <div className="bg-white font-sans text-slate-900 antialiased h-full flex flex-col overflow-hidden">
      ...
      <div className="lg:hidden h-full flex flex-col overflow-hidden bg-white">
        ...
        <div className="fixed bottom-0 left-0 right-0 p-5 bg-white border-t border-slate-100 flex gap-4 z-50">
          {step > 1 && (
            <button
              onClick={() => setStep(step - 1)}
              className="flex-1 py-4 rounded-xl border-2 border-slate-100 text-slate-500 font-bold hover:bg-slate-50 active:scale-95 transition-all text-sm uppercase tracking-wide"
            >
              Back
            </button>
          )}
          {step < totalSteps ? (
            <button
              onClick={() => setStep(step + 1)}
              className="flex-[2] bg-primary text-white py-4 rounded-xl font-bold shadow-lg shadow-primary/20 hover:bg-blue-600 active:scale-95 transition-all text-sm uppercase tracking-wide flex items-center justify-center gap-2"
            >
              Next Step
              <ArrowRight size={18} />
            </button>
            ...
            <button
              onClick={handleSave}
              className="flex-[2] bg-emerald-500 text-white py-4 rounded-xl font-bold shadow-lg shadow-emerald-100 hover:bg-emerald-600 active:scale-95 transition-all text-sm uppercase tracking-wide"
            >
              Save Changes
            </button>
          )}
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <button
                onClick={() => {
                  ...
                  onSave(); // Trigger the actual save redirect/logic
                }}
