            ...
            <main className="lg:pt-20">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            ...
                            <div className="bg-background-light p-10 rounded-2xl border border-gray-100 shadow-sm">
                                ...
                                <p className="text-gray-600 leading-relaxed text-lg">
                                    Lasomaa exists to challenge African businesses to take initiative in producing, innovating and reshaping Africa's economy through digital and cross boarder connectivity.
                                </p>
                            </div>
                            {/* Vision Card */}
                            <div className="bg-background-light p-10 rounded-2xl border border-gray-100 shadow-sm">
                ...
                <section className="bg-background-light py-16 lg:py-20 border-t border-[#f0f1f5]">
                    <div className="max-w-3xl mx-auto px-6 text-center">
                        <h2 className="text-4xl md:text-5xl font-extrabold mb-8 text-slate-900 tracking-tight">
                            ...
                            <span className="hidden md:inline">The Lasomaa Story</span>
                        </h2>
                        <div className="space-y-6 text-gray-600 text-lg leading-relaxed text-left lg:text-center">
                            <p>
                                Founded in 2020, Lasomaa began with a simple observation: African businesses were producing world-class goods but struggling with the logistical hurdles of cross-border trade. What started as a small digital directory has evolved into a comprehensive B2B marketplace infrastructure.
                            </p>
                            <p>
                ...
                <section className="bg-primary py-16 lg:py-20 px-6 relative overflow-hidden">
                    ...
                    <div className="max-w-4xl mx-auto text-center relative z-10">
                        ...
                        <p className="text-white/80 text-lg mb-12">Join thousands of businesses already expanding their horizons with Lasomaa.</p>
